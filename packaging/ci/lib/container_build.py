...
def main():
    ...
    env = dict(os.environ, CARGO_HOME='/build/cargo-home', CARGO_TARGET_DIR='/target',
               GQY_BUILD_ID=args.build_identity, SOURCE_DATE_EPOCH=args.epoch,
    ...
    binary = 'gqy-voice' if args.component == 'voice' else 'gqy'
    ...
    with tempfile.TemporaryDirectory(prefix='gqy-version-') as home:
        probe_env = dict(env, GQY_HOME=home, HOME=home, XDG_RUNTIME_DIR=home)
