...
> **2026-09-14 已归档**:§1、§5、§9(含同日改判接入的 Mermaid)落地(用户确认);§5 的拓展归 `../../plan/2026-09-14/dev-workbench.md` 3.2。
> 总览:`../../plan/2026-09-14/main-tasks.md`。设计稿:`../../design/2026-09-14/main-tasks.md`(小节编号与设计稿、总览一致,拆分时保留)。
