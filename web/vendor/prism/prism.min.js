/*!
 * PrismJS 1.29.0 (MIT) — https://prismjs.com
 * Vendored subset. Rebuild by concatenating these components in this exact order:
 *   core markup css clike javascript typescript c cpp go rust python bash
 *   json toml yaml sql lua diff markdown
 * Source: https://cdnjs.cloudflare.com/ajax/libs/prism/1.29.0/components/prism-<name>.min.js
 * Loaded with data-manual: GQY only calls Prism.tokenize() and builds the DOM
 * itself (web/highlight.js), so Prism must never touch the document on its own.
 */
